      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {/* FORGOT PASSWORD */}
            <div className="slide-up flex justify-end" style={{ animationDelay: '0.25s' }}>
          ...
          <div className="slide-up space-y-3" style={{ animationDelay: '0.4s' }}>
            <button className="w-full py-4 bg-white border border-neutral-200 rounded-full font-body font-medium text-black hover:bg-neutral-50 hover:border-neutral-300 transition-all flex items-center justify-center gap-3">
          ...
          {/* REGISTER LINK */}
          <p className="slide-up text-center mt-10 font-body text-neutral-500" style={{ animationDelay: '0.45s' }}>
          ...
          {/* ADMIN LINK */}
          <p className="slide-up text-center mt-4 font-body text-neutral-400 text-sm" style={{ animationDelay: '0.5s' }}>
